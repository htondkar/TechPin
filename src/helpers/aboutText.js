...
TechPin will never accept any advertisement, sponsorship or favoritism in ratings from any entity.`;

const whatIsRating = `Editors are professionals & contributors that are helping to grow TechPin further more. If you contribute a certain amount to TechPin, automatically you’ll become an Editor. The only difference is your rating will be calculate in Editors’ rating instead.`;

const NPS = `The Net Promoter Score is an index ranging from -100 to 100 that measures the willingness of customers to recommend a company's products or services to others. It is used as a proxy for gauging the customer's overall satisfaction with a company's product or service and the customer's loyalty to the brand.
